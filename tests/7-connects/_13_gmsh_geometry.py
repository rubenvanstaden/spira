...
class B(spira.Cell):
    ...
    def create_elementals(self, elems):
        ...
        p1 = spira.Rectangle(alias='P1', p1=(11*1e6, 9*1e6), p2=(21*1e6, 1*1e6), layer=RDD.PLAYER.M1.METAL)
    ...
    def create_ports(self, ports):
        ...
        ports += spira.Port(name='P3', midpoint=(15*1e6, 9*1e6), orientation=90, process=RDD.PROCESS.M3)
