...
class B(spira.Cell):
    ...
    def create_elementals(self, elems):
        ...
        p3 = spira.Rectangle(alias='P3', p1=(0*1e6, 7*1e6), p2=(15*1e6, 9*1e6), layer=RDD.PLAYER.M1.METAL)
        p4 = spira.Rectangle(alias='P4', p1=(14*1e6, 9*1e6), p2=(16*1e6, 1*1e6), layer=RDD.PLAYER.M1.METAL)
    ...
    def create_ports(self, ports):
        ...
        ports += spira.Port(name='P4', midpoint=(0*1e6, 8*1e6), orientation=180, process=RDD.PROCESS.M3)
        # ports += spira.Port(name='P5', midpoint=(15*1e6, 8*1e6), orientation=0, process=RDD.PROCESS.M3)
