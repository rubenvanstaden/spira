import spira
from spira.geometry.shapes.basic import *
from spira.geometry.shapes.advance import *
...
if __name__ == '__main__':
    ...
    circle = spira.Polygon(shape=circle_shape, gds_layer=spira.Layer(number=13))
    circle.center = (0,0)
    cell += circle
