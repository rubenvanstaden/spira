...
# from core.initializer import MetaInitializer
from core.initializer import FieldInitializer
from core import param
from core.mixin import MixinBowl


class __Transformable__(MixinBowl):
# class __Transformable__(metaclass=MetaInitializer):
# class __Transformable__(FieldInitializer):
