...
from core.mixin import MetaMixinBowl, MixinBowl
from core.descriptor import BaseField
...
class MetaBase(MetaMixinBowl):
    ...
    def mixin(cls, mixin_class):
        ...
        #         print(c)
        # print('\n=============================\n')
        # for name, c in cls.registry.items():
        #     if issubclass(c, cls):
        #         c.bind_parameters()
...
# class __Field__(MixinBowl, metaclass=MetaInitializer):
