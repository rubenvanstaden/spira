...
from spira.io import *
from spira.utils import scale_coord_down as scd
from core.param.field.typed_graph import EdgeCapacitor
from core.param.field.typed_graph import EdgeInductor
...
class PlotlyGraph(object):
    ...
    def _create_nodes(self, G, labeltext):
        ...
        from spira.gdsii.polygon import __Polygon__
