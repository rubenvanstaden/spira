...
class Magnification(__ConvertableTransform__):
    ...
    def __init__(self, magnification_center=(0.0, 0.0), magnification=1.0, **kwargs):
        super().__init__(magnification_center=magnification_center, magnification=magnification, **kwargs)
    ...
    def set_magnification_center(self, center):
        ...
        if hasattr(self, '__magnification__'):
            self.translation = Coord((1 - self.__magnification__) * center.x, (1 - self.__magnification__) * center.y)
    magnification_center = SetFunctionField('__magnification_center__', set_magnification_center, restriction=RestrictType(Coord), preprocess=ProcessorTypeCast(Coord), default=(0.0, 0.0))
...
#     #     if hasattr(self, "__magnification_center__"):
#     #         center = self.__magnification_center__
#     #         self.translation = Coord((1 - self.__magnification__) * center.x,
...
#     #         self.translation = Coord((1 - self.__magnification__) * center.x,
#     #                                       (1 - self.__magnification__) * center.y)
#     # magnification_center = SetFunctionProperty("__magnification_center__", set_magnification_center, restriction = RestrictType(Coord), preprocess = ProcessorTypeCast(Coord), default = (0.0, 0.0))
