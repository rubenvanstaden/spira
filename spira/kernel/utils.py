...
def intersection_filter(elements, filter_polygons):
    from spira.kernel.typed_list import ElementList
    elems = ElementList()
    for e in elements:
...
def polygons_to_elements(sp, params={}):
    ...
    """
    from spira.kernel.typed_list import ElementList
    from spira.kernel.polygons import Polygons
...
#     pass
#     # from spira.kernel.elemental.polygons import Polygons
#     # from spira.kernel.parameters.field.typed_integer import Integer
#     # new_masks = {}
