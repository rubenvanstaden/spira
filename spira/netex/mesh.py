...
class __Mesh__(meshio.Mesh, FieldInitializer):

    data = ElementalListField()
    gmsh_periodic = ElementalListField()
    level = IntegerField(default=1)

    points = DataField(fdef_name='create_points')
    cells = DataField(fdef_name='create_cells')
    point_data = DataField(fdef_name='create_point_data')
    cell_data = DataField(fdef_name='create_cell_data')
    field_data = DataField(fdef_name='create_field_data')
    node_sets = DataField(fdef_name='create_node_sets')
