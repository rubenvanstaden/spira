...
class Test_Manhattan_180(spira.Cell):
    ...
    def test_q1_180(self):
        ...
        rm = Route(port1=p1, port2=p2)
        return spira.SRef(reference=rm, midpoint=(0,0))
...
class Test_Manhattan_90(spira.Cell):
    ...
    def test_q1_90(self):
        ...
        return spira.SRef(reference=rm)
        # return spira.SRef(reference=rm, midpoint=(5*1e6,5*1e6))
    ...
    def test_q4_90(self):
        ...
        return spira.SRef(rm, midpoint=(50*1e6,-5*1e6))
...
class Test_Manhattan_Horizontal(spira.Cell):
    ...
    def test_p1p2_180_horizontal(self):
        p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=0, width=2*1e6)
        p2 = spira.Terminal(name='P2', midpoint=(40*1e6,0), orientation=0, width=2*1e6)
        rm = Route(port1=p1, port2=p2, radius=8*1e6)
        return spira.SRef(rm, midpoint=(5*1e6,5*1e6))
    ...
    def test_p1p2_180_bot(self):
        p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=180, width=2*1e6)
        p2 = spira.Terminal(name='P2', midpoint=(40*1e6,0), orientation=180, width=2*1e6)
        rm = Route(port1=p1, port2=p2, radius=8*1e6)
        return spira.SRef(rm, midpoint=(5*1e6,-5*1e6))
...
class Test_Manhattan_Vertical(spira.Cell):
    ...
    def test_p1p2_180_vertical(self):
        p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=90, width=2*1e6)
        p2 = spira.Terminal(name='P2', midpoint=(0,-40*1e6), orientation=90, width=2*1e6)
        rm = Route(port1=p1, port2=p2, radius=8*1e6)
        return spira.SRef(rm, midpoint=(-5*1e6,-5*1e6))
...
class Test_Manhattan_180_SimilarAngles(spira.Cell):
    ...
    def test_q1_parallel(self):
        p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=self.angle, width=2*1e6)
        p2 = spira.Terminal(name='P2', midpoint=(50*1e6,50*1e6), orientation=180, width=2*1e6)
        rm = Route(port1=p1, port2=p2, radius=8*1e6)
        return spira.SRef(rm, midpoint=(5*1e6, -5*1e6))
