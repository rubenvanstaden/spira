...
#     p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=0, width=2)
#     p2 = spira.Terminal(name='P2', midpoint=(50,25), orientation=90, width=1.5)
#     rm = Route180(port1=p1, port2=p2, radius=10)


# def test_routes_q2_180():
#     p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=0, width=2)
#     p2 = spira.Terminal(name='P2', midpoint=(-50,25), orientation=180, width=1.5)
#     rm = Route180(port1=p1, port2=p2, radius=10)


# def test_routes_q3_180():
#     p1 = spira.Terminal(name='P1', midpoint=(0,0), orientation=0, width=2)
#     p2 = spira.Terminal(name='P2', midpoint=(-50,-25), orientation=0, width=2)
#     rm = Route180(port1=p1, port2=p2, radius=10)
