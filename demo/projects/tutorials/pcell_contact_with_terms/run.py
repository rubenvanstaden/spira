...
class ViaPCell(spira.Cell):
    ...
    def create_ports(self, ports):
        ...
        ports += spira.Term(name='P1', midpoint=(-self.width/2, 0), width=self.width, orientation=90)
        ports += spira.Term(name='P2', midpoint=(self.width/2, 0), width=self.width, orientation=90)
